...
3. **Add your resource** using the provided agentic skill or command (see [.cursor/skills/add-resource/SKILL.md](./.cursor/skills/add-resource/SKILL.md)). Do **not** edit `resources.md` by hand.
4. **Commit and push** your branch.
5. **Open a Merge Request** with a short description of the resource and why it’s useful.

### Important

**Please do not edit `resources.md` manually.** Use the add-resource skill/command so that:
